...
Worked examples mapping common UK prescriptions to FHIR R4
MedicationRequest resources, using dm+d codes.

Written by a student pharmacist learning FHIR. Each example was chosen
because it breaks the mapping in a different way.

## Examples

### Amoxicillin 500mg capsules
Acute course: one capsule three times a day for 7 days, 21 supplied.
...
- **boundsDuration, not expectedSupplyDuration.** Both could hold
  "7 days", but they mean different things — how long to take it
  versus how long the supply lasts. For amoxicillin they coincide;
  for a 28-day repeat of an indefinite medication they don't.
  Recorded the clinical fact, not the logistics one.
